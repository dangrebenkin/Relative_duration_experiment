import pandas as pd
import textgrid, numpy, os, argparse
...
if __name__ == '__main__':
	...
	parser.add_argument('-path', dest='files_path', type=str, help='TextGrid files path', required=False)
	args = parser.parse_args()
	
	os.chdir(args.files_path)
	...
	print ('Results.csv is in ',args.files_path)
